...
namespace KolevDiamond.Infrastructure.Migrations
{
    ...
    [Migration("20260305173656_UpdateSeedImagePaths")]
    partial class UpdateSeedImagePaths
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KolevDiamond.Infrastructure.Data.Models.InvestmentCoin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("InvestmentCoins", t =>
                        {
                            t.HasComment("Investment coin specifications");
                        });
            ...
            modelBuilder.Entity("KolevDiamond.Infrastructure.Data.Models.InvestmentDiamond", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("InvestmentDiamonds", t =>
                        {
                            t.HasComment("Investment diamond specifications");
                        });
            ...
            modelBuilder.Entity("KolevDiamond.Infrastructure.Data.Models.MetalBar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("MetalBars", t =>
                        {
                            t.HasComment("Metal bar specifications");
                        });
            ...
            modelBuilder.Entity("KolevDiamond.Infrastructure.Data.Models.Necklace", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Necklaces", t =>
                        {
                            t.HasComment("Necklace specifications");
                        });
            ...
            modelBuilder.Entity("KolevDiamond.Infrastructure.Data.Models.Ring", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Rings", t =>
                        {
                            t.HasComment("Ring specifications");
                        });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4bd178f7-da47-412d-8d0e-f9e35130b99d",
                            Email = "admin@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@GMAIL.COM",
                            NormalizedUserName = "ADMIN@GMAIL.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEOg8TO0RGCk32GfV+u2qLDYGJ/uygqcdZIoq/yrm+7XP1+fmgvjWrzcR714N5IEI4w==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "ab875002-6698-4ad7-962e-fa884b9a93d9",
